...
class Sophia(BaseOptimizer):
    ...
    def __init__(
        ...
        """Initialize Sophia. beta2 for Hessian estimate via Hutchinson's estimator."""
        super().__init__(
    ...
    def reset(self):
        """Reset iteration, history, gradient EMA, and Hessian estimate."""
        super().reset()
        self.m = None
        self.h = None
    ...
    def step(
        ...
        """Sophia step: EMA gradients and Hessian-scale update via Hutchinson estimator."""
