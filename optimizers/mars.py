...
class MARS(BaseOptimizer):
    ...
    def __init__(
        ...
        """Initialize MARS. avg_beta for gradient averaging; lr_scheduler overrides decay_rate if set."""
        super().__init__(
    ...
    def reset(self):
        """Reset iteration, history, velocities, and averaged gradients."""
        super().reset()
    ...
    def step(
        ...
        """MARS step: gradient averaging plus momentum with optional bias correction."""
