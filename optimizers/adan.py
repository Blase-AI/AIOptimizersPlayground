...
class Adan(BaseOptimizer):
    ...
    def __init__(
        ...
        """Initialize Adan. beta3 smooths gradient difference for Nesterov-like update."""
        super().__init__(
    ...
    def reset(self):
        """Reset iteration, history, and moment buffers."""
        super().reset()
        self.m = None
        self.v = None
        self.g_prev = None
    ...
    def step(
        ...
        """Adan step: adaptive moments and gradient-difference Nesterov momentum."""
        if self.m is None:
